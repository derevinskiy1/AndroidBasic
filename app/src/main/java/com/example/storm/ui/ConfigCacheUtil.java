...
/**
 * Created by zhiwenyan on 12/21/16.
 */
...
//
//        String result = null;
//        String path = SyncStateContract.Constants.ENVIROMENT_DIR_CACHE + StringUtils.replaceUrlWithPlus(EncryptUtils.encryptToMD5(url));

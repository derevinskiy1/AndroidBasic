...
package com.example.storm.dayandnighttheme.dialog;
...
import com.example.storm.dayandnighttheme.R;
...
public class CardPickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case android.R.id.button1:   //ok
                if (mClickListener != null) {
                    mClickListener.onConfirm(mCurrentTheme);
                }
            case android.R.id.button2:   //cancel
                dismiss();
                break;
